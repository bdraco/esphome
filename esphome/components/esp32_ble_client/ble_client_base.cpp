...
void BLEClientBase::gattc_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t esp_gattc_if,
  ...
  switch (event) {
    ...
    case ESP_GATTC_CFG_MTU_EVT: {
      ESP_LOGW(TAG, "ESP_GATTC_CFG_MTU_EVT: Free Heap Size: %u bytes", heap_caps_get_free_size(MALLOC_CAP_INTERNAL));
    ...
    case ESP_GATTC_SEARCH_RES_EVT: {
      ESP_LOGW(TAG, "ESP_GATTC_SEARCH_RES_EVT: Free Heap Size: %u bytes", heap_caps_get_free_size(MALLOC_CAP_INTERNAL));
    ...
    case ESP_GATTC_SEARCH_CMPL_EVT: {
      ESP_LOGW(TAG, "ESP_GATTC_SEARCH_CMPL_EVT: Free Heap Size: %u bytes", heap_caps_get_free_size(MALLOC_CAP_INTERNAL));
