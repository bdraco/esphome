...
#endif
#ifdef USE_BLUETOOTH_PROXY
bool APIServerConnectionBase::send_bluetooth_unparsed_le_advertisement_response(const BluetoothUnparsedLEAdvertisementResponse &msg) {
#ifdef HAS_PROTO_MESSAGE_DUMP
  ESP_LOGVV(TAG, "send_bluetooth_unparsed_le_advertisement_response: %s", msg.dump().c_str());
#endif
  return this->send_message_<BluetoothUnparsedLEAdvertisementResponse>(msg, 85);
}
#endif
